...
export default function Search() {
  ...
  useEffect(() => {
    // Clear the search term when navigating away from the search page
    if (!location.pathname.includes('/search')) {
      setSidebarData(prevData => ({ ...prevData, searchTerm: "" }));
    }
  }, [location.pathname]);
  return (
    <div className="flex flex-col md:flex-row">
      <div className="p-7 border-b-2 md:border-r-2 md:min-h-screen">
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          ...
          <button className="bg-emerald-50 text-emerald-900 border-emerald-900 border p-3 rounded-lg uppercase hover:opacity-95 disabled:opacity-80">
            Search
          </button>
        </form>
      </div>
      <div className="flex-1">
        ...
        <div className="p-7 flex flex-wrap justify-center flex-wrap gap-4">
