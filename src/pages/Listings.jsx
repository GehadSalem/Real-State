...
export default function Listings() {
  ...
  useEffect(() => {
    const fetchOfferListings = async () => {
        setLoading(true);
      try {
        const res = await fetch('/listing/get?offer=true&limit=4');
    ...
    const fetchRentListings = async () => {
      ...
      try {
        const res = await fetch('/listing/get?type=rent&limit=4');
        const data = await res.json();
    ...
    const fetchSaleListings = async () => {
      ...
      try {
        const res = await fetch('/listing/get?type=sale&limit=4');
        const data = await res.json();
